...
//        $app->config->set('laravel-cart.classes.adjustment', Adjustment::class);
        $app->config->set('laravel-cart.classes.order_log_item', StripeOrderLogItem::class);
    }
//
    protected function setUp(): void
    {
        parent::setUp(); // TODO: Change the autogenerated stub
        //Config::set('laravel-cart.classes.order_log_item', StripeOrderLogItem::class);
    ...
    public function it_will_log_an_order_log_item($exception_class, $expected_message)
    {
        ...
        //$this->cart->initializePayment($order);
        try {
            $payment_intent->create($order);
        } catch (\Exception $e) {
