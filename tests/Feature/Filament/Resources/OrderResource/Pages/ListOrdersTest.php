...
it('will allow overriding of the related resource class', function () {
    ...
    expect(\Antidote\LaravelCartFilament\Resources\OrderResource\Pages\ListOrders::getResource())
...
->coversClass(\Antidote\LaravelCartFilament\Resources\OrderResource\Pages\ListOrders::class);
